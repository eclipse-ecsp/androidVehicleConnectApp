...
fun VehicleSelectionListView(
    ...
    Column(
        ...
        if (isSelectViewVisible.value) {
            Card(modifier = Modifier.testTag("vehicle_card_view_tag"),
        ...
        if (isSelectedViewVisible.value) {
            Card(
                ...
                Row(
                    ...
                    Text(
                        text = selectedItemName.value, color = Black,
                        modifier = Modifier
                            .fillMaxHeight()
                            .wrapContentWidth()
        ...
        if (isListViewVisible.value) {
            LazyColumn(
                ...
                itemsIndexed(vehicleList) { index, item ->
                    ...
                    {
                        Text(
                            text = (item?.vehicleDetailData?.vehicleAttributes?.name
                                ?: "No Device Id"),
                            modifier = Modifier
